    ...
    <div className="min-h-screen bg-bg-dark flex flex-col">
      ...
      <div className="flex-1 max-w-7xl w-full mx-auto px-4 py-8">
        <div className="flex flex-col lg:flex-row gap-6 items-start justify-center">
          {/* Left Sidebar: Latest News (Desktop Only) */}
          <aside className="hidden lg:block w-72 xl:w-80 shrink-0 sticky top-20">
            <LatestNews />
          </aside>

          {/* Main Feed Column */}
          <main className="flex-1 min-w-0 max-w-2xl w-full space-y-8">
          ...
          {/* Right Sidebar: Latest 50 Activities (Desktop Only) */}
          <aside className="hidden lg:block w-72 xl:w-80 shrink-0 sticky top-20">
            <ActivityCard users={data.users} posts={data.posts} />
          </aside>
        </div>
      </div>
    </div>
